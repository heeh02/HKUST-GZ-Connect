...
- copy/save-only Clash and Mihomo YAML plus a copy-only VS Code Remote-SSH configuration snippet;
...
- generic copy/save adapters for Clash-compatible YAML and Mihomo YAML;
...
- an External Tool Integration Center for profile-bound Clash YAML, Mihomo YAML, and a VS Code Remote-SSH
