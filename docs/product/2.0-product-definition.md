...
| Resource-triggered connection limitation | [`campus-browser-manager.js`](../../desktop/lib/browser/session/campus-browser-manager.js) | manager currently connects before open; its route helper can distinguish Direct |
