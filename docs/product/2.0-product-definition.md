...
- Current implementation baseline: `de35d652fe5cb4681830782a2929d20f4eca9df3` plus the uncommitted
  `codex/2.0-product-convergence` worktree recorded in the Phase 0 audit
- Implementation status: [`../2.0-status.md`](../2.0-status.md); P1-P7 and stabilization are merged, P8 is on the active review branch, and P9 is not implemented
- First packaged beta: HKUST(GZ) is the only reviewed Profile, while `Other school` provides an explicitly
  unverified Custom Gateway path; formal reviewed multi-school support still requires a second reviewed Profile

HKUST(GZ) is the only reviewed Profile in the first packaged beta. Other schools remain user-selectable through
