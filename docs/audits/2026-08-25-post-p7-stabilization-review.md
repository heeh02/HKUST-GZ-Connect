...
| F-04 façade hides transitive complexity | Confirmed | `app-data-dir.js` exports persistence, migration, switching, relaunch and multi-school startup through one misleading name. Architecture Gate v2 must measure transitive dependencies and domain fan-out. |
