...
- HKUST(GZ) Connect当前implementation固定为
  `35996adb4d52d8dba5e6a4e2f92582260ac4228e`；已发布v1.2.3仍固定为`5d8323d`。
...
| External Tool Integration Center | N/A：官方native integration不适合作为独立客户端模板 | CLI/local proxy配置，secret与profile边界不同 | `I3/E3`；P7 generic export、Clash Verge Rev owned extension、OpenSSH Include/profile conf、preview/backup/atomic validate/rollback | 真实第三方客户端导入/连接仍是独立canary，不由文件写入测试代替 |
