...
- Status: Historical 2.0 design record
- Owner: architecture maintainers
- Last verified: 2026-09-04 for archival classification
- Applies to: original 2.0 design rationale; current behavior is governed by `../../2.0-status.md`
...
[`resource-domain-model.md`](../../architecture/resource-domain-model.md)；External Tool Integration Center见
