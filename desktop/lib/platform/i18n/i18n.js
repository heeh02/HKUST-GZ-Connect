...
const dictionaries = {
  zh: {
    ...
    'error.underlayUnavailable': '所选出站网卡或源 IP 当前不可用，请恢复默认直连或重新选择',
    ...
    'browser.categoryResearch': '科研、进度与计算',
    'browser.categoryFinance': '缴费与报销',
    'browser.categoryCareer': '实习、就业与发展',
    'browser.categoryCampusLife': '住宿与空间',
    'browser.categoryApplications': '申请与离校',
    'browser.categoryServices': '通用工具',
    'browser.categoryNewcomer': '入学、账号与迎新',
    'browser.categoryCourses': '课程、选课与成绩',
    'browser.categoryLabs': '实验室与仪器',
    'browser.categoryStudentFinance': '学费、奖助与津贴',
    'browser.categoryExpenses': '经费、采购与报销',
    'browser.categoryDocuments': '申请、证明与毕业',
    'browser.categoryTools': '协作、图书馆与 IT',
    'browser.categoryStaff': '教师与行政',
  ...
  en: {
    ...
    'error.underlayUnavailable': 'The selected outbound interface or source IP is unavailable. Restore Default Direct or choose another path.',
    ...
    'browser.categoryResearch': 'Research, Progress & Computing',
    'browser.categoryFinance': 'Fees & Expenses',
    'browser.categoryCareer': 'Internships, Career & Development',
    'browser.categoryCampusLife': 'Housing & Spaces',
    'browser.categoryApplications': 'Requests & Leaving',
    'browser.categoryServices': 'General Tools',
    'browser.categoryNewcomer': 'Onboarding & Account',
    'browser.categoryCourses': 'Courses, Enrollment & Grades',
    'browser.categoryLabs': 'Labs & Instruments',
    'browser.categoryStudentFinance': 'Fees, Aid & Studentships',
    'browser.categoryExpenses': 'Funding, Procurement & Expenses',
    'browser.categoryDocuments': 'Applications, Documents & Graduation',
    'browser.categoryTools': 'Collaboration, Library & IT',
    'browser.categoryStaff': 'Teaching & Administration',
