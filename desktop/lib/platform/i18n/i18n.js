...
const dictionaries = {
  zh: {
    ...
    'browser.neutralHomeBody': '可以在上方地址栏输入网址，或返回主窗口从收藏、最近打开和校园服务中选择。',
  ...
  en: {
    ...
    'browser.neutralHomeBody': 'Enter a URL above, or return to the main window to choose from favorites, recent sites, and campus services.',
