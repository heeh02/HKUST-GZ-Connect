...
const dictionaries = {
  zh: {
    ...
    'browser.categoryNewcomer': '新生入学',
    'browser.categoryCourses': '课程与考试',
    'browser.categoryLabs': '实验与仪器',
    'browser.categoryStudentFinance': '财务缴费',
    'browser.categoryExpenses': '报销与采购',
    'browser.categoryDocuments': '证明、毕业与离校',
    'browser.categoryTools': '通用工具',
    'browser.categoryStaff': '教职工工具',
  ...
  en: {
    ...
    'browser.categoryNewcomer': 'New Student',
    'browser.categoryCourses': 'Courses & Exams',
    'browser.categoryLabs': 'Labs & Instruments',
    'browser.categoryStudentFinance': 'Student Finance',
    'browser.categoryExpenses': 'Expenses & Procurement',
    'browser.categoryDocuments': 'Documents & Graduation',
    'browser.categoryTools': 'General Tools',
    'browser.categoryStaff': 'Staff Tools',
