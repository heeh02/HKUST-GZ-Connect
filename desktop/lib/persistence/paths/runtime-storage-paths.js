...
function createLegacyRuntimeStoragePaths(userData) {
  ...
  return finalize('legacy-flat', root, {
    ...
    resourceFavorites: path.join(root, 'favorites.json'),
    resourceRecents: path.join(root, 'recent-resources.json'),
...
function createProfileWorkspaceRuntimeStoragePaths(authority) {
  ...
  return finalize('profile-workspace', root, {
    ...
    resourceFavorites: layout.workspace.favorites,
    resourceRecents: layout.workspace.recentResources,
